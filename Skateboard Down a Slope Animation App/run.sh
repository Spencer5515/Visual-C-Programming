...
echo "Compile LightInterface.cs to create the file: boardInterface.dll"
mcs -t:library -r:System.Windows.Forms.dll -r:System.Drawing.dll -out:boardInterface.dll boardInterface.cs

echo "Compile main.cs and link the previously created dll file(s) to create an executable file."
mcs -r:System.Windows.Forms.dll -r:System.Drawing.dll -r:boardInterface.dll -out:line.exe main.cs
