...
#echo "Compile LightLogic.cs to create the file: LightLogic.dll"
#mcs -t:library -r:System.Drawing.dll -out:LightLogic.dll LightLogic.cs

echo "Compile LightInterface.cs to create the file: LightInterface.dll"
mcs -t:library -r:System.Windows.Forms.dll -r:System.Drawing.dll -out:LightInterface.dll LightInterface.cs

echo "Compile main.cs and link the previously created dll file(s) to create an executable file."
mcs -r:System.Windows.Forms.dll -r:System.Drawing.dll -r:LightInterface.dll -out:TrafficLight.exe main.cs
